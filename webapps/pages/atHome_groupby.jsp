...
function eventHandler(eventObj) {
	...
	case "EIS_IRKEY_RIGHT":
		if (getFocusID=="category_53"||getFocusID=="category_96"||getFocusID=="category_126") {
			window.location.href="atHome_coupon.jsp";
			return 0;
		}
		break;
	case "EIS_IRKEY_BACK":
...
function init(){
	...
	var urlStr=escape(interfaceurl+getGrouponCategorys+"?count=10&mac=deciveId&parentid=0&usercode=1&athome=true");
...
function handlGroupby(result){
	...
	for(var i=0;i<categorys.length;i++){
		...
		try{
			...
			document.getElementById("category_"+cateID+"_a").href=encodeURI(document.getElementById("category_"+cateID+"_a").href+"&itemsCount="+category.sum_soft+"&categoryName="+category.name+"&type=&athome=1");
			document.getElementById("category_"+cateID+"_a").href=encodeURI(document.getElementById("category_"+cateID+"_a").href+"&itemsCount="+category.sum_soft+"&categoryName="+category.name+"&type=&athome=1");
		}
		catch(e){
...
<!-- 背景图片以及头部图片 -->
<div  id="main_div">
	<img id="main_img" src="../dzdp/atHome_groupbuyBG.png"  border="0" width="1280" height="720" />
...
<div id="header">
	<div style="position: absolute; color:#ffffff; width:200px; top: 60px; left: 143px; height: 59px; font-size:32px;">
		家附近
	</div>
	<div id="menu_back" style="position:absolute; top: 90px; left: 93px; width: 61px; height: 73px;">
		<a id="menu_back_a" href="module.jsp" onfocus="menuOnfocus('menu_back')" onblur="menuLostfocus('menu_back')">
			<img id="menu_back_img" src="../dzdp/dot.png" width="30" height="30">
		</a>
	</div>
	<div id="menu_1" style="position:absolute; top: 0px; left: 360px; width: 154px; height: 142px;">
		<a id="menu_1_a" href="atHome_groupby.jsp" onfocus="menuOnfocus('menu_1')" onblur="menuLostfocus('menu_1')">
			<img id="menu_1_img" src="../dzdp/dot.png" width="128" height="122">
		</a>
	</div>
	<div id="menu_2" style="position:absolute;top: 0px; left: 545px; width: 170px; height: 142px;">
		<a id="menu_2_a" href="atHome_coupon.jsp" onfocus="menuOnfocus('menu_2')" onblur="menuLostfocus('menu_2')">
			<img id="menu_2_img" src="../dzdp/dot.png" width="128" height="122">
		</a>
	</div>
	<div id="menu_3" style="position:absolute; top: 0px; left: 735px; width: 184px; height: 142px;">
		<a id="menu_3_a" href="atHome.jsp" onfocus="menuOnfocus('menu_3')" onblur="menuLostfocus('menu_3')">
			<img id="menu_3_img" src="../dzdp/dot.png" width="122" height="122">
		</a>
	</div>
	<div id="menu_back_Focus" style="position:absolute;visibility: hidden;top:42px;left:58px;width:100px;height:87px;" >
		<img id="menuFocus_back_img" src="../dzdp/btn_back_focus.png" width="100" height="87" />
	</div>
	<div id="menu_1_Focus" style="position: absolute; visibility: hidden; top: 0px; left: 354px; width: 154px; height: 142px;">
		<img id="menuFocus_1_img" src="../dzdp/title_game1.png">
	</div>
	<div id="menu_2_Focus" style="position: absolute; visibility: hidden; top: 0px; left: 538px; width: 170px; height: 142px;">
		<img id="menuFocus_2_img" src="../dzdp/youhuijuan1.png">
	</div>
	<div id="menu_3_Focus" style="position: absolute; visibility: hidden; top: 0px; left: 731px; width: 184px; height: 142px;">
		<img id="menuFocus_3_img" src="../dzdp/menu_athome_focus.png">
	</div>
</div>
<div id="content" style="position:absolute;top:0px;left:0px;width:1280px;height:720px;">
	...
	<div id="category_68" style="position:absolute;top:352px;left:79px;width:184px;height:149px;" >
		<a id="category_68_a" href="categoryChildList.jsp?categoryId=68&pageId=10" onfocus="menuOnfocus('category_68')" onblur="menuLostfocus('category_68')">
			...
			<span id="category_68_name" style="position: absolute;top: 18px;left:0px; width: 170px;text-align: right;font-weight: bold; color:#ffffff;font-size: 28px;">抽奖</span>
			<span id="category_68_count" style="position: absolute;top: 110px;left:0px; width: 170px;text-align: right;font-weight: bold; color:#ffffff;font-size: 28px;"><span style="font-size: 18px; padding-left:5px;"></span></span>
		</a>
	</div>
	...
	<div id="category_96"  style="position:absolute;top:351px;left:1021px;width:185px;height:149px;">
		<a id="category_96_a" href="categoryChildList.jsp?categoryId=96&pageId=13" onfocus="menuOnfocus('category_96')" onblur="menuLostfocus('category_96')">
			...
			<span id="category_96_name" style="position: absolute;top: 18px;left:0px; width: 170px;text-align: right;font-weight: bold; color:#ffffff;font-size: 28px;">酒店</span>
			<span id="category_96_count" style="position: absolute;top: 110px;left:0px; width: 170px;text-align: right;font-weight: bold; color:#ffffff;font-size: 28px;"><span style="font-size: 18px; padding-left:5px;"></span></span>
		</a>
	</div>
	...
	<div id="category_68_Focus" style="position:absolute;visibility:hidden;top:347px;left:70px;width:195px;height:167px;" >
		<img id="menuFocus_68_img" src="../dzdp/choujiang_Focus.png" width="195" height="167" />
			<span id="category_68_name_focus" style="position: absolute;top: 18px;left:0px; width: 170px;text-align: right;font-weight: bold; color:#ffffff;font-size: 28px;">酒店</span>
			<span id="category_68_count_focus" style="position: absolute;top: 110px;left:0px; width: 170px;text-align: right;font-weight: bold; color:#ffffff;font-size: 28px;"><span style="font-size: 18px; padding-left:5px;"></span></span>
	</div>
	...
	<div id="category_96_Focus"  style="position:absolute;visibility:hidden;top:347px;left:1019px;width:192px;height:167px;">
		<img id="menuFocus_96_img" src="../dzdp/jiudian.png" width="192" height="167" />
			<span id="category_96_name_focus" style="position: absolute;top: 18px;left:0px; width: 170px;text-align: right;font-weight: bold; color:#ffffff;font-size: 28px;">酒店</span>
			<span id="category_96_count_focus" style="position: absolute;top: 110px;left:0px; width: 170px;text-align: right;font-weight: bold; color:#ffffff;font-size: 28px;"><span style="font-size: 18px; padding-left:5px;"></span></span>
	</div>
