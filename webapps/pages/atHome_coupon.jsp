...
function eventHandler(eventObj) {
	...
	case "EIS_IRKEY_RIGHT":
		if (getFocusID=="category_39"||getFocusID=="category_76"||getFocusID=="category_94") {
			window.location.href="atHome.jsp";
			return 0;
		}
		break;
	case "EIS_IRKEY_BACK":
...
function init(){
	...
	var urlStr=escape(interfaceurl+getCouponCategorys+"?count=10&parentid=0&mac=deciveId&usercode=1&athome=true");
...
function handlCoupon(result){
	...
	for(var i=0;i<categorys.length;i++){
		...
		try{
			...
			document.getElementById("category_"+category.category_id+"_a").href=encodeURI(document.getElementById("category_"+category.category_id+"_a").href+"&itemsCount="+category.sum_soft+"&categoryName="+category.name+"&type=C&athome=1");
			document.getElementById("category_"+category.category_id+"_a").href=encodeURI(document.getElementById("category_"+category.category_id+"_a").href+"&itemsCount="+category.sum_soft+"&categoryName="+category.name+"&type=C&athome=1");
		}
		catch(e){
...
<!-- 背景图片以及头部图片 -->
<div  id="main_div">
	<img id="main_img" src="../dzdp/atHome_couponBG.png"  border="0" width="1280" height="720" />
</div>
<div id="header">
...
<div id="content" style="position:absolute;top:0px;left:0px;width:1280px;height:720px;">
	...
	<div id="category_23" style="position:absolute;top:195px;left:458px;width:369px;height:149px;" >
		<a id="category_23_a" href="categoryChildList.jsp?categoryId=23&pageId=18" onfocus="menuOnfocus('category_23')" onblur="menuLostfocus('category_23')">
			...
			<span id="category_23_name" style="position: absolute;top: 110px;left: 222px;font-weight: bold; color:#ffffff;font-size: 28px;">休闲娱乐</span>
		</a>
	</div>
	...
	<div id="category_48_Focus" style="position:absolute;visibility:hidden;top:342px;left:74px;width:192px;height:167px;" >
		<img id="menuFocus_48_img" src="../dzdp/youhuijuan_liren_Focus.png" width="195" height="167" />
			<span id="category_48_count_focus" style="position: absolute;top: 110px;left:0px; width: 170px;text-align: right;font-weight: bold; color:#ffffff;font-size: 28px;"><span style="font-size: 18px; padding-left:5px;"></span></span>
			<span id="category_48_name_focus" style="position: absolute;top: 18px;left:0px; width: 170px;text-align: right;font-weight: bold; color:#ffffff;font-size: 28px;"></span>
	</div>
	...
	<div id="category_76_Focus"  style="position:absolute;visibility:hidden;top:342px;left:1015px;width:192px;height:167px;">
		<img id="menuFocus_76_img" src="../dzdp/youhuijuan_jianshen_Focus.png" width="195" height="167" />
			<span id="category_76_name_focus" style="position: absolute;top: 110px;left:0px; width: 170px;text-align: right;font-weight: bold; color:#ffffff;font-size: 28px;"><span style="font-size: 18px; padding-left:5px;"></span></span>
			<span id="category_76_count_focus" style="position: absolute;top: 18px;left:0px; width: 170px;text-align: right;font-weight: bold; color:#ffffff;font-size: 28px;"></span>
	</div>
