...
<script>
	...
	function up(){
				//alert(currentFocusId+" "+pageIndex+" "+pageCount);
			if (pageCount == 0) {
				return;
			}else if (pageIndex == 1 ){
			...
			if (pageIndex>1 && pageCount>1){
				pageIndex--;
				var myCollectUrl = "<%=request.getContextPath()%>/getCollection.do?p="+(pageIndex-1)+"&s="+pageSize+"&r="+Math.random();
				//resetRequest();
	...
	function down(){
			...
			if (pageIndex<pageCount && pageCount>1){
				var myCollectUrl = "<%=request.getContextPath()%>/getCollection.do?p="+(pageIndex)+"&s="+pageSize+"&r="+Math.random();
				//resetRequest();
				ajaxReq = new AJAX_OBJ(myCollectUrl,afterGetCollect);
				ajaxReq.requestData();
				pageIndex++;
	...
	function afterGetCollect(xmlHttpResponse){
		...
		for(var i=0;i<9;i++){
			...
			if (collect ==null){
				...
				$id('date'+(i+1)+'_div').innerText = collect.collectTimeStr.substr(0,collect.collectTimeStr.indexOf(' ',0));
	...
	function startReqData(){
		var myCollectTotalUrl = "<%=request.getContextPath()%>/getCollectionTotal.do?r="+Math.random();
		//resetRequest();
...
<div id="pr_div" style="position:absolute;left:690; top:-35; width:131; height:62;" ><epg:img id="pr" src="/common/images/tools/pg_d.png" width="131" height="62"  href="#" onclick="down()" onfocus="pageOnfocus('pr')" /></div>
	...
	<div align="center" id="c1_div" style="position:absolute;top:30px; left:21px; width:820px; height:60px;" >
		...
		<div align="left" id="date1_div" style="position:absolute;top:18px; left:670px; width:140px; height:66px;" >
		</div>
	...
	<div align="center" id="c2_div" style="position:absolute;top:90px; left:21px; width:820px; height:60px;" >
		...
		<div align="left" id="date2_div" style="position:absolute;top:18px; left:670px; width:140px; height:66px;" >
		</div>
	...
	<div align="center" id="c3_div" style="position:absolute;top:150px; left:21px; width:820px; height:70px;" >
		...
		<div align="left" id="date3_div" style="position:absolute;top:18px; left:670px; width:140px; height:66px;" >
		</div>
	...
	<div align="center" id="c4_div" style="position:absolute;top:210px; left:21px; width:820px; height:70px;" >
		...
		<div align="left" id="date4_div" style="position:absolute;top:18px; left:670px; width:140px; height:66px;" >
		</div>
	...
	<div align="center" id="c5_div" style="position:absolute;top:270px; left:21px; width:820px; height:70px;" >
		...
		<div align="left" id="date5_div" style="position:absolute;top:18px; left:670px; width:140px; height:66px;" >
		</div>
	...
	<div align="center" id="c6_div" style="position:absolute;top:330px; left:21px; width:820px; height:70px;" >
		...
		<div align="left" id="date6_div" style="position:absolute;top:18px; left:670px; width:140px; height:66px;" >
		</div>
	...
	<div align="center" id="c7_div" style="position:absolute;top:390px; left:21px; width:820px; height:70px;" >
		...
		<div align="left" id="date7_div" style="position:absolute;top:18px; left:670px; width:140px; height:66px;" >
		</div>
	...
	<div align="center" id="c8_div" style="position:absolute;top:450px; left:21px; width:820px; height:70px;" >
		...
		<div align="left" id="date8_div" style="position:absolute;top:18px; left:670px; width:140px; height:66px;" >
		</div>
	...
	<div align="center" id="c9_div" style="position:absolute;top:510px; left:21px; width:820px; height:70px;" >
		...
		<div align="left" id="date9_div" style="position:absolute;top:18px; left:670px; width:140px; height:66px;" >
		</div>
