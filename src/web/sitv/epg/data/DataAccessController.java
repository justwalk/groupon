...
public class DataAccessController extends AbstractController {
	...
	//private static Logger logger = Logger.getLogger(DataAccessController.class);
	...
	private void writeBi(String biType,String pageId,String funcId,String funcContent,String mac,String itemId,String itemType, String urlStr){
		//System.out.println(DataAccessController.class.getResource("/").toString());
		//System.out.println(System.getProperty("user.dir"));
		
		String str = getClass().getResource("/").getFile().toString();
		String dir = str.substring(0, str.indexOf("webapps")); 
		org.apache.log4j.LogManager.resetConfiguration();
		org.apache.log4j.PropertyConfigurator.configure(dir+"src/log4j.properties");
		try{
			String log="";
			if(biType!=null){
				if(biType.equals("1")){
